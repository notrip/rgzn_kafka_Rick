...
public class KafkaAdminDemo {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        //3.查看一个topic的具体信息
        DescribeTopicsResult tpc_1= adminClient.describeTopics(Arrays.asList("tpc_1","tpc_2"));
        KafkaFuture<Map<String, TopicDescription>> future = tpc_1.all();
        Map<String, TopicDescription> stringTopicDescriptionMap = future.get();     //get（）会阻塞知道拿到返回值
        ...
        NewTopic tpc_10 = new NewTopic("tpc_10",2,(short) 3);
